...
if ($clothingType === 'top') {
    $sql = "INSERT INTO TOP (iid, type, material, pattern, isdress) VALUES ('$itemId', ?, ?, ?, ?)";
            "INSERT INTO ITEM (iid, available, attire, color, istop, isbot, isshoes, isacc) VALUES ('$itemId', 1, ?, ?, 1, 0, 0, 0)";
} elseif ($clothingType === 'bottom') {
    $sql = "INSERT INTO BOTTOM (iid, type) VALUES ('$itemId', ?)";
          "INSERT INTO ITEM (iid, available, attire, color, istop, isbot, isshoes, isacc) VALUES ('$itemId', 1, ?, ?, 0, 1, 0, 0)";
} elseif ($clothingType === 'shoe') {
    $sql = "INSERT INTO SHOES (iid, type, brand) VALUES ('$itemId', ?, ?)";
          "INSERT INTO ITEM (iid, available, attire, color, istop, isbot, isshoes, isacc) VALUES ('$itemId', 1, ?, ?, 0, 0, 1, 0)";
} elseif ($clothingType === 'accessory') {
    $sql = "INSERT INTO ACCESSORY (iid, type, brand) VALUES ('$itemId', ?, ?)";
          "INSERT INTO ITEM (iid, available, attire, color, istop, isbot, isshoes, isacc) VALUES ('$itemId', 1, ?, ?, 1, 0, 0, 1)";
}
